...
| L3 语法层·动词 | `03-Interaction-Grammar.md` | 待补（索引） | → Vol III 第一·二章（交互语法/组件哲学）、Vol I 第五章 |
| L3 语法层·图形 | `03-Visualization-Grammar.md` | **新写** ✅ | 四卷与 L2 均无此层；十条可视化语法（AVL）+ 3D 准入四门 + 每条附 HCI 实验依据 |
