...
export default function SentenceRibbon({
  ...
  return (
    <div
      ref={ref}
      className="sentence-ribbon pointer-events-auto mx-auto max-w-[min(640px,88%)] overflow-x-auto whitespace-nowrap rounded-md border-2 border-obs-line bg-obs-2 px-3 py-1.5 text-center shadow-float [scrollbar-width:none]"
    >
